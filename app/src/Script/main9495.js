...
hardshipCanvas = document.createElement("canvas"); hardshipContext = hardshipCanvas.getContext("2d"); hardshipCanvas.width = 190; hardshipCanvas.height = 215;
...
imgLoad(playSrc, function() {
	...
	hardshipContext.drawImage(playSrc, 0, 416, 190, 215, 0, 0, 190, 215);
